...
export default function CommentForm({ autoFocus = false, spaceId, postId, parentId }) {
  ...
  return (
    <div className='small'>
      <MDBTextArea autoFocus={autoFocus} value={text} onChange={(e) => setText(e.target.value)} style={{ padding: '10px', borderRadius: '5px', fontSize: '14px' }} rows={3} label='Comment' className="mt-2 small" >
      </MDBTextArea>
